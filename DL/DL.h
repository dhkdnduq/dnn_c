...
extern "C" DLDLL int  torch_get_batch_size(int gpu = 0);
...
extern "C" DLDLL int torch_category_classification(category_rst_list &rst_list, int gpu = 0, bool is_clear_buffer = true );
extern "C" DLDLL int torch_anomaly_detection(segm_t_container_rst_list &rst_list,  int gpu = 0, bool is_clear_buffer = true);
...
extern "C" DLDLL int  trt_get_batch_size(int gpu = 0);
...
extern "C" DLDLL int trt_binary_classification(binary_rst_list &rst_list, int gpu = 0,bool is_clear_buffer = true);
